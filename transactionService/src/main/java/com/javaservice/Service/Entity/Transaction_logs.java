...
public class Transaction_logs implements Serializable {
	...
	public Transaction_logs(String logs_name,Long logs_id, Transaction transaction_id, Account account_id, BigDecimal previous_balance,
			BigDecimal newbalance, String timestamp ,String amount) {
		super();
